...
var AppComponent = /** @class */ (function () {
    function AppComponent(dataService) {
        ...
        this.genre = new Genre(); // изменяемый товар
    ...
    AppComponent.prototype.loadGenres = function () {
        var _this = this;
        this.dataService.getGenres()
            .subscribe(function (data) { return _this.genres = data; });
    };
    // сохранение данных
    AppComponent.prototype.save = function () {
        ...
        if (this.genre.id == null) {
            ...
            this.dataService.updateGenre(this.genre)
                .subscribe(function (data) { return _this.loadGenres(); });
        }
        this.cancel();
    };
